...
// El siguiente ejemplo usa la filter_var()función para desinfectar una cadena. Eliminará todas las etiquetas HTML y todos los caracteres con valor ASCII > 127 de la cadena:
